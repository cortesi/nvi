...
- The [nvirun.nvim](github.com/cortesi/nvirun.nvim) plugin to install, update
  and run nvi plugins. Plugins are installed and updated using `cargo` - the
  only requirement on the user is to have working Rust installation.
